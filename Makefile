...
build/zzz: main.c build/wlr-data-control-protocol.o build/zzz_list.o build/read_config.o build/config_parse.o build/storer.o build/daemon.o build/getter.o build/lister.o build/registry.o
